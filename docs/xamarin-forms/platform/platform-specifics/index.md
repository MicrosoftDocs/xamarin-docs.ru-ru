...
1. Создайте класс для конкретной платформы, который предоставит результат. Дополнительные сведения см. [в разделе Создание класса, зависящего от платформы](#creating-a-platform-specific-class).
