...
ms.locfileid: "97940269"
---
# <a name="ios-platform-features-in-no-locxamarinforms"></a>функции платформы iOS в Xamarin.Forms
...
- Управление тем [`FlyoutPage`](xref:Xamarin.Forms.FlyoutPage) , применяется ли к ней теневая страница, при раскрытии всплывающей страницы. Дополнительные сведения см. в разделе [Флйоутпаже Shadow](flyoutpage-shadow.md).
...
Xamarin.Forms включает установку стилей и цветов пользовательского интерфейса для различных платформ. но существуют и другие варианты настройки темы для iOS с помощью API платформы в проекте iOS.
