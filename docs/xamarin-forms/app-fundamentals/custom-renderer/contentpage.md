...
![Связь между классом ContentPage и реализующими нативными элементами управления](contentpage-images/contentpage-classes.png)
...
1. [Создание](#creating-the-xamarinforms-page) страницы Xamarin.Forms.
1. [Использование](#consuming-the-xamarinforms-page) страницы из Xamarin.Forms.
1. [Создание](#creating-the-page-renderer-on-each-platform) пользовательского отрисовщика для страницы на каждой платформе.
...
## <a name="creating-the-no-locxamarinforms-page"></a>Создание страницы Xamarin.Forms
...
## <a name="consuming-the-no-locxamarinforms-page"></a>Использование страницы Xamarin.Forms
...
![Задачи проекта пользовательского отрисовщика CameraPage](contentpage-images/solution-structure.png)
...
![CameraPage на каждой платформе](contentpage-images/screenshots.png)
...
- [CustomRendererContentPage (пример)](/samples/xamarin/xamarin-forms-samples/customrenderers-contentpage)