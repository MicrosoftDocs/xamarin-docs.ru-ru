---
title: description: 'Эта статья поясняет, как использовать класс DependencyService в Xamarin.Forms для выбора фотографии в библиотеке рисунков на телефоне.'
