...
ms.locfileid: "93373007"
---
# <a name="enterprise-application-patterns-using-no-locxamarinforms-ebook"></a>Электронная книга "Шаблоны корпоративного приложения с использованием Xamarin.Forms"
...
## <a name="dependency-injection"></a>[Внедрение зависимостей](dependency-injection.md)
...
## <a name="authentication-and-authorization"></a>[Аутентификация и авторизация](authentication-and-authorization.md)
