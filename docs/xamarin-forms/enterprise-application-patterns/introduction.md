...
Однако существует множество проблем, которые необходимо устранить при секционировании приложения в отдельные слабо связанные компоненты. Вот они:
...
|Validations (Проверки)|Содержит классы, участвующие в проверке входных данных.|
