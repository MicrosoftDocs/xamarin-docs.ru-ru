...
Однако существует множество проблем, которые необходимо устранить при секционировании приложения в отдельные слабо связанные компоненты. К ним относятся:
...
Дополнительные сведения об этих функциях см. в [ Xamarin.Forms документации](~/xamarin-forms/index.yml)и о [создании мобильных приложений с Xamarin.Forms помощью ](https://aka.ms/xamebook).
