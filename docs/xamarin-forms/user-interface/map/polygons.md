---
title: Геомногоугольники, ломаные и круговые схемы в Xamarin. Forms
description: В этой статье объясняется, как создавать многоугольники, ломаные и круги на экземпляре схемы Xamarin. Forms.
ms.prod: xamarin
