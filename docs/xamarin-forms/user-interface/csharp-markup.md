...
ms.locfileid: "93367924"
---
# <a name="no-locxamarinforms-c-markup"></a>Xamarin.Forms Разметка C#

![Предварительный выпуск API](~/media/shared/preview.png)

[![Загрузить образец](~/media/shared/download.png) загрузить пример](/samples/xamarin/xamarin-forms-samples/userinterface-csharpmarkupdemos/)
