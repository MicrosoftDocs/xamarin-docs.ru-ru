...
CocosSharp — это гибкая, мощная технология для отображения графики, чтения сенсорного ввода, воспроизведения звука и управления содержимым. В этом руководство объясняется, как добавить CocosSharp в Xamarin.Forms приложение.
...
1. [Создание страницы Xamarin Forms](#1-creating-a-xamarin-forms-page)
1. [Добавление Кокосшарпвиев](#2-adding-a-cocossharpview)
1. [Создание Гамесцене](#3-creating-the-gamescene)
1. [Добавление круга](#4-adding-a-circle)
1. [Взаимодействие с CocosSharp](#5-interacting-with-cocossharp)
