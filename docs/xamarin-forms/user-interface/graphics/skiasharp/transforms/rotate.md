...
description: В этой статье рассматриваются эффекты и анимации, доступные при использовании преобразования «SkiaSharp вращение», и демонстрируется пример кода.
ms.prod: xamarin
