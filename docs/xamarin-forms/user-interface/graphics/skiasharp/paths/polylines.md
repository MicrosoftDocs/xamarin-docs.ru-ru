...
![Спираль](polylines-images/spiralexample.png)
...
[![Тройной снимок экрана со страницей спирали Арчимедеан](polylines-images/archimedeanspiral-small.png)](polylines-images/archimedeanspiral-large.png#lightbox "Тройной снимок экрана со страницей спирали Арчимедеан")
