...
---| Заголовок---: "Горячая перезагрузка XAML для Xamarin.Forms " Description: "Перезагрузите изменения в файл XAML мгновенно в работающем приложении, чтобы не создавать Xamarin.Forms проект после каждого изменения XAML."
MS. произв. MS. AssetID: MS. Technology: Автор: MS. author: MS. Дата: нет-Loc:
- 'Xamarin.Forms'
- 'Xamarin.Essentials'
...
---------| | Visual Studio 2019 | 16,4 или более поздней версии Visual Studio 2019 для Mac | 8,4 или более Xamarin.Forms | 4,1 или более
