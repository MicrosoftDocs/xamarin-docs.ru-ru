...
Поиск Azure также поддерживает получение предложений на основе входных данных поиска. Дополнительные сведения см. в разделе [запросы предложений](#suggestions).
