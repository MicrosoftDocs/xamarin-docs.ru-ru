...
| `Markup_Experimental` | 5,0 (перемещено в набор средств Xamarin Community Toolkit) |
| `MediaElement_Experimental` | 5,0 (перемещено в набор средств Xamarin Community Toolkit) |
