...
[![Пример Уиалертвиевконтроллер](alerts-images/alert01.png)](alerts-images/alert01.png#lightbox)
...
[![Пример оповещения](alerts-images/alert04.png)](alerts-images/alert04.png#lightbox)
...
`AddAction`Метод добавляет заданное действие в и, `UIAlertViewController` наконец, `PresentViewController (alertController, true, null)` метод отображает данное предупреждение пользователю.
...
[![Текстовое поле в предупреждении](alerts-images/alert02.png)](alerts-images/alert02.png#lightbox)
...
[![Ввод текста](alerts-images/alert03.png)](alerts-images/alert03.png#lightbox)
