...
2. Выберите **Сборка tvOS** и убедитесь, что вы используете конфигурацию **выпуска** : 
    ...
    [![Выбор параметров сборки tvOS](troubleshooting-images/ts01.png)](troubleshooting-images/ts01.png#lightbox)
...
Для приложений или библиотек, которые включают допустимый bitcode, значение `size` будет больше единицы. В некоторых ситуациях, когда библиотека может иметь маркер bitcode, но не содержит допустимого bitcode. Например.
...
[![Выполнение задачи MTouch](troubleshooting-images/mtouch01.png)](troubleshooting-images/mtouch01.png#lightbox)
