...
[![Удаленный и игровой контроллер Bluetooth](remote-bluetooth-images/intro01.png)](remote-bluetooth-images/intro01.png#lightbox)
...
[![Siri Remote](remote-bluetooth-images/remote01.png)](remote-bluetooth-images/remote01.png#lightbox)
...
|**Корневая папка**<br />Нажмите клавишу, чтобы вернуться на начальный экран, дважды щелкните для отображения работающих приложений, нажмите и удерживайте в спящем режиме.|Недоступно|Недоступно|
|**Громкость**<br />Управляет подключенным звуковым или видеооборудованием.|Недоступно|Недоступно|
...
|---|---|---|
|![Перемещение выделенного фрагмента](remote-bluetooth-images/Gesture01.png)|![Активно выбранный элемент](remote-bluetooth-images/Gesture02.png)|![Кнопки направления](remote-bluetooth-images/Gesture03.png)|
...
2. Перетащите **распознаватель жестов касания** из **библиотеки** и поместите его в представление:
    ...
    [![Распознаватель жестов TAP](remote-bluetooth-images/storyboard01.png)](remote-bluetooth-images/storyboard01.png#lightbox)
3. Установите флажок **выбрать** в разделе **"Кнопка"** **инспектора атрибутов**:

    [![Флажок "выбрать"](remote-bluetooth-images/storyboard02.png)](remote-bluetooth-images/storyboard02.png#lightbox)
...
5. Затем следует связать **действие** **распознавателя жестов TAP** и вызвать его `TouchSurfaceClicked` :
    ...
    [![Действие распознавателя жестов касания](remote-bluetooth-images/storyboard03.png)](remote-bluetooth-images/storyboard03.png#lightbox)
...
[![Игровые контроллеры Bluetooth](remote-bluetooth-images/game01.png)](remote-bluetooth-images/game01.png#lightbox)
...
[![Редактор info. plist](remote-bluetooth-images/game02.png)](remote-bluetooth-images/game02.png#lightbox)
