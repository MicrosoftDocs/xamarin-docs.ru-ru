...
1. Выберите **Provisioning**  >  **Разработка**подготовки.
2. Нажмите кнопку **+** и укажите **имя** и **идентификатор пакета** для нового приложения.
...
Помимо выбора и настройки необходимых Службы приложений при определении идентификатора приложения необходимо также настроить идентификатор и назначения приложения в проекте Xamarin. tvOS, изменив `Info.plist` `Entitlements.plist` файлы и.
...
1. Выберите **Provisioning**  >  **распределение**подготовки.
