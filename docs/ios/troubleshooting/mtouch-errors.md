...
Пользовательские ресурсы — это файлы, включенные в сборки (в виде ресурсов), которые необходимо извлечь во время сборки, чтобы создать пакет приложений. Сюда относится следующие действия:
