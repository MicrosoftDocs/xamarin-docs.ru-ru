...
2. Откройте файл **Entitlements.plist** и выберите возможности, которые требуется добавить:
    ...
    ![Снимок экрана: содержимое файла Entitlements.plist.](images/image17.png)
    ...
    ![Снимок экрана: уведомление о завершении автоматической подготовки.](images/image18.png)
