...
ms.author: daortin
ms.date: 03/20/2017
ms.openlocfilehash: 849b19217a81a808dd86cacb68748731ff721e02
ms.sourcegitcommit: 4bbf54d2bc1df96af69814e2e5dae47be12e0474
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 03/10/2021
ms.locfileid: "102602818"
---
...
Хотя приложение полностью создает пользовательский интерфейс из кода, а не создает единую раскадровку с использованием Interface Builder Xcode, применяются те же методы. 
...
По умолчанию в любом новом проекте Xamarin. iOS будут использоваться классы размера. Чтобы использовать классы размера и адаптивные Переходовы в раскадровке из старого проекта, сначала необходимо преобразовать его в формат унифицированной раскадровки Xcode 6, а в инспекторе файлов Xcode для раскадровки установлен флажок использовать классы размера.
...
Наконец, в этой статье были рассмотрены основы создания отдельного экрана динамического запуска, который будет отображаться в качестве экрана запуска на каждом устройстве iOS 8.
