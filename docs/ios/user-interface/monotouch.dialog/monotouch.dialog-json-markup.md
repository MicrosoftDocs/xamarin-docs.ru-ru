...
Приведенная выше разметка создает следующий пользовательский интерфейс:
 ...
 [![Пользовательский интерфейс, созданный заданной разметкой](monotouch.dialog-json-markup-images/screen-shot-2012-03-02-at-11.31.31-am.png)](monotouch.dialog-json-markup-images/screen-shot-2012-03-02-at-11.31.31-am.png#lightbox)
