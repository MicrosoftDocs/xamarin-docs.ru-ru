...
11. Добавьте новый ключ с **типом** `Dictionary` :
    ...
    [![Добавьте еще один новый ключ с типом словаря в Visual Studio для Mac.](implementing-sirikit-images/plist10.png)](implementing-sirikit-images/plist10.png#lightbox)
