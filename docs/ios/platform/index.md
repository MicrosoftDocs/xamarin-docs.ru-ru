...
## <a name="document-picker"></a>[Средство выбора документов](~/ios/platform/document-picker.md)
...
## <a name="handoff"></a>[перемещение вручную;](~/ios/platform/handoff.md)
...
## <a name="search-apis"></a>[Интерфейсы API для поиска](~/ios/platform/search/index.md)
...
При работе с iOS можно столкнуться с ситуациями, когда требуется использовать сторонние библиотеки цели-C. В таких ситуациях можно использовать проекты привязки с поддержкой однокасания для создания привязки C# к библиотекам машинного задания на языке C. В проекте используются те же средства, которые используются для переноса API-интерфейсов iOS в C#. В этом документе описывается, как привязать API цели-C.
