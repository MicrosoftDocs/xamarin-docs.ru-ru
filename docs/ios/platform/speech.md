...
API распознавания речи предоставляет результаты обратно в вызывающее приложение практически в реальном времени, так как пользователь говорит о нем и предоставляет дополнительные сведения о результатах перевода, чем просто текст. Вот они:
...
3. Щелкните **Добавить новую запись**, введите `NSSpeechRecognitionUsageDescription` для **Свойства** `String` **тип** и **Описание использования** в качестве **значения**. Например. 

    [![Добавление Нсспичрекогнитионусажедескриптион](speech-images/speech03.png)](speech-images/speech03.png#lightbox)
4. Если приложение будет обрабатывать голосовую транскрипцию, для него также потребуется описание использования микрофона. Щелкните **Добавить новую запись**, введите `NSMicrophoneUsageDescription` для **Свойства** `String` **тип** и **Описание использования** в качестве **значения**. Например. 
...
1. Дважды щелкните `Info.plist` файл, чтобы открыть его для редактирования.
2. Щелкните **Добавить новую запись**, введите `NSSpeechRecognitionUsageDescription` для **Свойства** `String` **тип** и **Описание использования** в качестве **значения**. Например. 

    [![Добавление Нсспичрекогнитионусажедескриптион](speech-images/speech03w.png)](speech-images/speech03w.png#lightbox)
3. Если приложение будет обрабатывать голосовую транскрипцию, для него также потребуется описание использования микрофона. Щелкните **Добавить новую запись**, введите `NSMicrophoneUsageDescription` для **Свойства** `String` **тип** и **Описание использования** в качестве **значения**. Например. 
