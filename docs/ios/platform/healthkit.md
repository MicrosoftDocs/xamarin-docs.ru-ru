...
[![Пример приложения для записи частоты сердца пользователей](healthkit-images/image01.png)](healthkit-images/image01.png#lightbox)
...
[![Регистрация приложения на портале разработчика Apple](healthkit-images/image02.png)](healthkit-images/image02.png#lightbox)
...
[![Выберите явный идентификатор приложения](healthkit-images/image03.png)](healthkit-images/image03.png#lightbox)
...
[![Создание профиля подготовки](healthkit-images/image04.png)](healthkit-images/image04.png#lightbox)
...
[![Просмотр профиля в Xcode](healthkit-images/image05.png)](healthkit-images/image05.png#lightbox)
...
[![Введите явный идентификатор приложения](healthkit-images/image06.png)](healthkit-images/image06.png#lightbox)
...
[![Выберите профиль подготовки](healthkit-images/image07.png)](healthkit-images/image07.png#lightbox)
...
[![Диаграмма объектов Хксамплетипе](healthkit-images/image08.png)](healthkit-images/image08.png#lightbox)
...
[![Большая часть данных в пакете работоспособности имеет тип Хккуантититипе и хранит их данные в объектах Хккуантитисампле.](healthkit-images/image09.png)](healthkit-images/image09.png#lightbox)
...
[![Пользователю предоставляется диалоговое окно для доступа к работоспособности, управляемое системой](healthkit-images/image10.png)](healthkit-images/image10.png#lightbox)

Позже пользователь может изменить разрешения с помощью диалогового окна **источники** приложения работоспособности:

[![Пользователь может изменять разрешения с помощью диалогового окна источники приложений работоспособности](healthkit-images/image11.png)](healthkit-images/image11.png#lightbox)
...
Теперь, когда модель была запрограммирована, пришло время увидеть, как контроллер отражает состояние модели. Откройте файл `HKWorkViewController.cs`. Конструктор просто подразделяет `HeartRateModel` одноэлементный класс на методы обработки событий (опять же, это можно сделать с помощью лямбда-выражений, но отдельные методы делают цель немного более очевидна):
...
[![Пользователь будет представлен в этом диалоговом окне](healthkit-images/image12.png)](healthkit-images/image12.png#lightbox)
...
[![На этой схеме показана последовательность событий](healthkit-images/image13.png)](healthkit-images/image13.png#lightbox)
...
- [Хкворк (пример)](/samples/xamarin/ios-samples/ios8-introtohealthkit)
