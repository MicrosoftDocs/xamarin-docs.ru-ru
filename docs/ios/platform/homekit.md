...
`HMHome`Объект содержит список назначенных аксессуаров, которые могут быть представлены пользователю в его `Accessories` свойстве. Например.
