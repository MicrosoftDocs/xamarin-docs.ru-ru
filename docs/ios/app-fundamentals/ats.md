...
- Для всех сертификатов необходимо использовать по крайней мере отпечаток SHA256 с ключом RSA (2048 или выше) или с ключом 256 бит или более Elliptic-Curve (ECC).
...
### <a name="opting-out-of-ats"></a>Opting-Out ATS
...
[![Представление источника файла INFO. plist после добавления указанных ключей.](ats-images/ats01.png)](ats-images/ats01.png#lightbox)
...
[![Представление источника файла INFO. plist после указания Нсалловсарбитрарилоадсинвебконтент и Нсалловсарбитрарилоадс.](ats-images/ats02.png)](ats-images/ats02.png#lightbox)
