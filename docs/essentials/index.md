...
## <a name="get-started-with-no-locxamarinessentials"></a>[Начало работы с Xamarin.Essentials](get-started.md?context=xamarin/xamarin-forms)
...
* [Действия приложения](app-actions.md?context=xamarin/xamarin-forms) — получение и задание сочетаний клавиш для приложения.
...
* [Контакты](contacts.md?context=xamarin/xamarin-forms) — получение сведений о контакте на устройстве.
...
* [Средство выбора файлов](file-picker.md?context=xamarin/xamarin-forms) — позволяет пользователю выбирать файлы на устройстве.
...
* [Тактильная обратная связь](haptic-feedback.md?context=xamarin/xamarin-forms) — управление щелчками мыши и длительным нажатием.
...
* [Средство выбора мультимедиа](media-picker.md?context=xamarin/xamarin-forms) — позволяет пользователю выбирать или снимать фотографии и видео.
...
* [Снимок экрана](Screenshot.md?context=xamarin/xamarin-forms) — позволяет сделать снимок текущего содержимого экрана приложения.
* [Безопасное хранилище](secure-storage.md?context=xamarin/xamarin-forms) — безопасное хранение данных.
* [Общий доступ](share.md?context=xamarin/xamarin-forms) — отправка текста и ссылок на веб-сайты другим приложениям.
...
## <a name="no-locxamarinessentials-on-qa"></a>[Xamarin.Essentials на сайте Q&A](/answers/topics/dotnet-xamarinessentials.html)

Задайте вопросы о доступе к собственным функциям в Xamarin.Essentials.

## <a name="release-notes"></a>[Заметки о выпуске](/xamarin/essentials/release-notes/)
