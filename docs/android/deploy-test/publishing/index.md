...
- **** Через веб-сайт.&ndash; Приложение Xamarin.Android можно сделать доступным для скачивания на веб-сайте, с которого пользователи могут затем установить приложение, щелкнув ссылку.
- **** По электронной почте.&ndash; Пользователи могут установить приложение Xamarin.Android из сообщения электронной почты. Приложение будет установлено при открытии вложения на устройстве на платформе Android.
...
- [HelloWorldPublishing (пример)](/samples/xamarin/monodroid-samples/helloworldpublishing)
- [Процесс сборки](~/android/deploy-test/building-apps/build-process.md)
- [Связывание](~/android/deploy-test/linker.md)
- [Получение ключа API Google Maps](~/android/platform/maps-and-location/maps/obtaining-a-google-maps-api-key.md)
- [Развертывание с помощью центра приложений Visual Studio](/appcenter/distribution/stores/googleplay)
