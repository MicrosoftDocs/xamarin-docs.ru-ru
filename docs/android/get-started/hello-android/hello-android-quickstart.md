...
[![Загрузить образец](~/media/shared/download.png) загрузить пример](/samples/xamarin/monodroid-samples/phoneword)
...
[![Снимок экрана окончательного варианта приложения, преобразующего телефонный номер.](hello-android-quickstart-images/vs/15-running-app-sml.png)](hello-android-quickstart-images/vs/15-running-app.png#lightbox)
