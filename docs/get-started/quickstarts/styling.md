---
title: 'title: "Стилизация кроссплатформенного приложения Xamarin.Forms" description: "В этой статье описывается изменение стиля кроссплатформенного приложения Xamarin.Forms с помощью стилей XAML".'
