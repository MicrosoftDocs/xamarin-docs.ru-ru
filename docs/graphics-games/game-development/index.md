...
![Это схема простого цикла игры](images/image1.png)
...
![В этом примере показана Декартовая плоскость с положительной Y, указывающей вверх](images/image2.png)
...
![фез](images/image7.png)

Бастиона

![Бастион](images/image8.jpg)
...
![UrhoSharp — Это высокоуровневая трехмерный и двумерный механизм, который можно использовать для создания анимированных трехмерных и 2D-сцен.](images/urhosharp.gif)
...
- **Опентк —** Опентк (который означает Open Tool Kit) предоставляет доступ к оборудованию iOS, Apple и Mac на низком уровне. Дополнительные сведения о Опентк см. на главной странице:[https://opentk.net/](https://opentk.net/)
