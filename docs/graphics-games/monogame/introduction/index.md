...
В этой статье описывается технология API для работы с несколькими платформами для создания кросс-платформенных игр. Полный список платформ см. на [веб-сайте для игр](http://www.monogame.net/). В этом учебнике для примеров кода будет использоваться C#, хотя функция "полная игра" также полностью работает с F #.
...
- [Проект Валкинггаме (пример)](/samples/xamarin/mobile-samples/walkinggamemg/)
