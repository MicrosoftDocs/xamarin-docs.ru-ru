...
Еще один важный шаг при использовании представлений слоев в приложении Xamarin. Mac — установка значения в `LayerContentsRedrawPolicy` `NSView` `OnSetNeedsDisplay` в `NSViewController` . Например.
...
Разработчик всегда должен использовать новую `NSView` версию на основе элементов управления представлением контейнеров, например `NSTableView` . Например.
