...
[![Пример запущенного приложения "Привет, Mac"](hello-mac-images/run02-sml.png)](hello-mac-images/run02.png#lightbox)
...
- последняя версия [Xamarin.Mac и Visual Studio для Mac](/visualstudio/mac/installation/).
...
1. Запустите Visual Studio для Mac:
    ...
    [![Основной интерфейс Visual Studio для Mac](hello-mac-images/setup01-sml.png)](hello-mac-images/setup01.png#lightbox)
...
2. Нажмите кнопку **Создать проект**. В открывшемся диалоговом окне **Создание проекта** последовательно щелкните **Mac** > **Приложение** > **Приложение Cocoa**, после чего нажмите кнопку **Далее**.
    ...
    [![Выбор приложения Cocoa](hello-mac-images/setup02-sml.png)](hello-mac-images/setup02.png#lightbox)

3. Введите `Hello_Mac` в поле **Имя приложения** и оставьте все остальные значения по умолчанию. Нажмите кнопку **Далее**:

    [![Задание имени приложения](hello-mac-images/setup03-sml.png)](hello-mac-images/setup03.png#lightbox)

4. Укажите для нового проекта расположение на своем компьютере.

    [![Проверка сведений о новом решении](hello-mac-images/setup04-sml.png)](hello-mac-images/setup04.png#lightbox)
...
[![Стандартное представление нового решения](hello-mac-images/project01-sml.png)](hello-mac-images/project01.png#lightbox)
...
[![Редактор plist в Visual Studio для Mac](hello-mac-images/infoplist01.png)](hello-mac-images/infoplist01.png#lightbox)
...
[![Редактор назначений Visual Studio для Mac](hello-mac-images/entitlements01.png)](hello-mac-images/entitlements01.png#lightbox)
...
[![Файл Main.storyboard в обозревателе решений](hello-mac-images/xcode01.png)](hello-mac-images/xcode01.png#lightbox)

Запустится Xcode. Открывшееся окно будет выглядеть следующим образом:

[![Представление по умолчанию конструктора Interface Builder Xcode](hello-mac-images/xcode02.png)](hello-mac-images/xcode02.png#lightbox)
...
[![Различные разделы конструктора Interface Builder в Xcode](hello-mac-images/xcode03.png)](hello-mac-images/xcode03.png#lightbox)
...
[![Инспектор свойств](hello-mac-images/xcode04.png)](hello-mac-images/xcode04.png#lightbox)
...
[![Обзор всех инспекторов](hello-mac-images/xcode05.png)](hello-mac-images/xcode05.png#lightbox)
...
[![Инспектор библиотеки Xcode](hello-mac-images/xcode06.png)](hello-mac-images/xcode06.png#lightbox)
...
1. В Xcode перетащите **нажимную кнопку**  из **раздела "Библиотека"** :
    ...
    [![Выбор NSButton в инспекторе библиотеки](hello-mac-images/xcode07.png)](hello-mac-images/xcode07.png#lightbox)

2. Поместите кнопку в узел **Представление** (в разделе **Контроллер окна**) в **редакторе интерфейса**:

    [![Добавление кнопки в проект интерфейса](hello-mac-images/xcode08.png)](hello-mac-images/xcode08.png#lightbox)
...
4. Перетащите **метку** из **раздела "Библиотека"** :
    ...
    [![Выбор метки в инспекторе библиотеки](hello-mac-images/xcode10.png)](hello-mac-images/xcode10.png#lightbox)

5. Поместите метку в область **Окно** рядом с кнопкой в **редакторе интерфейса**:

    [![Добавление метки в проект интерфейса](hello-mac-images/xcode11.png)](hello-mac-images/xcode11.png#lightbox)

6. Захватите правый маркер метки и перетаскивайте его до границы окна:

    [![Изменение размера метки](hello-mac-images/xcode12.png)](hello-mac-images/xcode12.png#lightbox)
...
7. Выберите кнопку, только что добавленную в **редактор интерфейса**, и щелкните значок **редактора ограничений** в нижней части окна:
    ...
    [![Добавление ограничений к кнопке](hello-mac-images/xcode13.png)](hello-mac-images/xcode13.png#lightbox)
...
11. Выберите метку и еще раз щелкните значок **редактора ограничений**.
    ...
    [![Добавление ограничений к метке](hello-mac-images/xcode14.png)](hello-mac-images/xcode14.png#lightbox)
...
[![Выбор элемента в иерархии интерфейса](hello-mac-images/xcode15.png)](hello-mac-images/xcode15.png#lightbox)
...
[![Просмотр исходного кода в Xcode](hello-mac-images/xcode16-sml.png)](hello-mac-images/xcode16.png#lightbox)
...
1. В Xcode в правом верхнем углу экрана нажмите кнопку с изображением **двойного круга**, чтобы открыть **вспомогательный редактор**:
    ...
    [![Отображение вспомогательного редактора](hello-mac-images/outlet01.png)](hello-mac-images/outlet01.png#lightbox)
...
4. В верхней части **редактора кода** щелкните **автоматическую ссылку** и выберите файл `ViewController.h`:
    ...
    [![Выбор нужного файла](hello-mac-images/outlet02.png)](hello-mac-images/outlet02.png#lightbox)

5. Теперь в Xcode должен быть выбран правильный файл:

    [![Просмотр файла ViewController.h](hello-mac-images/outlet03.png)](hello-mac-images/outlet03.png#lightbox)
...
7. Перейдите в **редактор интерфейса** и, удерживая нажатой клавишу **CTPL** на клавиатуре, щелкните и перетащите созданную метку в редактор кода сразу же под код `@interface ViewController : NSViewController {}`:
    ...
    [![Перетаскивание для создания переменной экземпляра](hello-mac-images/outlet04.png)](hello-mac-images/outlet04.png#lightbox)

8. Откроется диалоговое окно. Оставьте в поле **Подключение** значение **Переменная экземпляра** и введите `ClickedLabel` в поле **Имя**:

    [![Определение переменной экземпляра](hello-mac-images/outlet05.png)](hello-mac-images/outlet05.png#lightbox)

9. Нажмите кнопку **Подключить**, чтобы создать **переменную экземпляра**:

    [![Просмотр итоговой переменной экземпляра](hello-mac-images/outlet06.png)](hello-mac-images/outlet06.png#lightbox)
...
2. Перейдите в **редактор интерфейса** и, удерживая нажатой клавишу **CTPL** на клавиатуре, щелкните и перетащите созданную кнопку в редактор кода сразу же под код `@property (assign) IBOutlet NSTextField *ClickedLabel;`:
    ...
    [![Перетаскивание для создания действия](hello-mac-images/action01.png)](hello-mac-images/action01.png#lightbox)

3. Задайте параметру **Подключение** значение **Действие**:

    [![Определение действия](hello-mac-images/action02.png)](hello-mac-images/action02.png#lightbox)

4. Введите `ClickedButton` в поле **Имя**:

    [![Именование нового действия](hello-mac-images/action03.png)](hello-mac-images/action03.png#lightbox)

5. Нажмите кнопку **Подключить**, чтобы создать **действие**:

    [![Просмотр итогового действия](hello-mac-images/action04.png)](hello-mac-images/action04.png#lightbox)
...
[![Синхронизация изменений с Xcode](hello-mac-images/sync01-sml.png)](hello-mac-images/sync01.png#lightbox)
...
[![Просмотр файла ViewController.cs в Visual Studio для Mac](hello-mac-images/code01-sml.png)](hello-mac-images/code01.png#lightbox)
...
[![Выбор отладочной сборки](hello-mac-images/run01-sml.png)](hello-mac-images/run01.png#lightbox)
...
[![Запуск приложения](hello-mac-images/run02-sml.png)](hello-mac-images/run02.png#lightbox)

Если кнопка была нажата несколько раз, метка должна обновиться и отобразит количество раз нажатия:

[![Отображение результатов нажатия кнопки](hello-mac-images/run03-sml.png)](hello-mac-images/run03.png#lightbox)
