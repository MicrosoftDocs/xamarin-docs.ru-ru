...
В большинстве случаев отладчик в Visual Studio для Mac будет перехватывать исключения и сбои в приложении и помогает отслеживать основную причину. Однако в некоторых случаях приложение будет возводить на закрепление, а затем выйти с небольшим или без выходных данных. К ним может относиться следующее.
...
- Проверьте выходные данные приложения Visual Studio для Mac (**Просмотр**  ->  **Pads**  ->  **выходных данных приложения**PAD) для трассировки стека или вывода красным цветом из Cocoa, которые могут описывать выходные данные.
