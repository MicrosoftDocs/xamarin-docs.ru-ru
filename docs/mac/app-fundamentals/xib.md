...
![На снимке экрана показано окно настроек, отображаемое в меню приложение.](xib-images/new04.png "Выполнение примера приложения")
...
[![На снимке экрана показано представление таблицы, выбранное в окне Работа с изображениями.](xib-images/view04.png "Выполнение примера приложения")](xib-images/view04-large.png#lightbox)
