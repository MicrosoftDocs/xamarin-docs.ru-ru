...
[![Инспектор атрибутов](table-view-images/edit05.png)](table-view-images/edit05.png#lightbox)
...
[![Инспектор атрибутов](table-view-images/edit06.png)](table-view-images/edit06.png#lightbox)
...
[![Инспектор атрибутов](table-view-images/edit07.png)](table-view-images/edit07.png#lightbox)
...
[![Инспектор атрибутов](table-view-images/edit08.png)](table-view-images/edit08.png#lightbox)
...
[![Инспектор атрибутов](table-view-images/edit09.png)](table-view-images/edit09.png#lightbox)
...
3. Создайте **выход** для табличного представления с именем `ProductTable` : 
    ...
    [![Настройка розетки](table-view-images/edit13.png)](table-view-images/edit13.png#lightbox)
4. Создание **розеток** для столбцов таблиц также вызывается `ProductColumn` и `DetailsColumn` : 

    [![Настройка розетки](table-view-images/edit14.png)](table-view-images/edit14.png#lightbox)
...
[![Запуск примера приложения](table-view-images/populate02.png)](table-view-images/populate02.png#lightbox)
...
[![Задание ключа сортировки](table-view-images/sort01.png)](table-view-images/sort01.png#lightbox)

Выберите `Details` столбец, введите `Description` для **ключа сортировки** `compare:` для **селектора** и выберите `Ascending` для **заказа**:

[![Задание ключа сортировки](table-view-images/sort02.png)](table-view-images/sort02.png#lightbox)
...
[![Инспектор атрибутов](table-view-images/select01.png)](table-view-images/select01.png#lightbox)
...
[![Инспектор атрибутов](table-view-images/select02.png)](table-view-images/select02.png#lightbox)
...
[![Запуск примера приложения](table-view-images/type02.png)](table-view-images/type02.png#lightbox)
...
[![Инспектор атрибутов](table-view-images/reorder01.png)](table-view-images/reorder01.png#lightbox)
...
Чтобы включить изображение как часть ячейки в `NSTableView` , необходимо изменить способ возврата данных методом табличного представления `NSTableViewDelegate's` `GetViewForItem` для использования `NSTableCellView` вместо типичного `NSTextField` . Например.
