...
[![Инспектор атрибутов](outline-view-images/edit05.png)](outline-view-images/edit05.png#lightbox)
...
[![Инспектор атрибутов](outline-view-images/edit06.png)](outline-view-images/edit06.png#lightbox)
...
[![Инспектор атрибутов](outline-view-images/edit07.png)](outline-view-images/edit07.png#lightbox)
...
[![Инспектор атрибутов](outline-view-images/edit08.png)](outline-view-images/edit08.png#lightbox)
...
[![Инспектор атрибутов](outline-view-images/edit09.png)](outline-view-images/edit09.png#lightbox)
...
3. Создайте **выход** для представления структуры с именем `ProductOutline` :
    ...
    [![Настройка розетки](outline-view-images/edit13.png)](outline-view-images/edit13.png#lightbox)
4. Создание **розеток** для столбцов таблиц также вызывается `ProductColumn` и `DetailsColumn` :

    [![Настройка розетки](outline-view-images/edit14.png)](outline-view-images/edit14.png#lightbox)
...
[![Инспектор атрибутов](outline-view-images/select01.png)](outline-view-images/select01.png#lightbox)
...
[![Инспектор атрибутов](outline-view-images/select02.png)](outline-view-images/select02.png#lightbox)
...
[![Инспектор атрибутов](outline-view-images/reorder01.png)](outline-view-images/reorder01.png#lightbox)
...
Чтобы включить изображение как часть ячейки в `NSOutlineView` , необходимо изменить способ возврата данных методом представления структуры, `NSTableViewDelegate's` `GetView` чтобы использовать `NSTableCellView` вместо типичного `NSTextField` . Например.
