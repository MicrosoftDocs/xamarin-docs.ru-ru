...
Xamarin [UITest](/appcenter/test-cloud/preparing-for-upload/uitest) можно использовать для создания автоматизированных сценариев тестирования пользовательского интерфейса, которые могут выполняться локально или отправляться в [тест в центре приложений](/appcenter/test-cloud/).
...
В дополнение к очевидным техническим проблемам, которые могут привести к отклонению приложения, существует ряд более заметных аспектов отправки, которые могут привести к отправке, особенно в отношении метаданных (описание, ключевые слова и маркетинговые изображения), которые вы отправляете в приложение для показа в магазине приложений или Marketplace.
...
Процесс проверки может быть довольно нечетким, но, как и в остальной части жизненного цикла разработки, вы можете обеспечить успешное выполнение некоторых этапов планирования и внимания. Все это сводится к нескольким простым шагам: Прочитайте и изучите рекомендации по пользовательскому интерфейсу, которые необходимо соблюдать. Следуйте правилам, если вы реализуете функции для конкретных платформ, тщательно протестируйте (а затем протестируйте еще) и убедитесь, что метаданные приложения верны перед отправкой.
