...
[![На этой схеме показана архитектура межплатформенного приложения с использованием переносимой библиотеки классов для совместного использования кода, но также использование внедрения зависимостей для передачи функций, зависящих от платформы](pcl-images/image1.png)](pcl-images/image1.png#lightbox)
...
[![Структура решения показана здесь в Visual Studio для Mac и Visual Studio соответственно](pcl-images/image19.png)](pcl-images/image19.png#lightbox)
