...
![Решение с несколькими конфигурациями](multi-process-debugging-images/mpd01-xs.png)
...
![Части панели инструментов "Отладка"](multi-process-debugging-images/mpd02-xs.png)
...
1. **Конфигурация решения.** Можно задать конфигурацию решения, щелкнув конфигурацию в разделе "Решение" на панели инструментов отладки и выбрав нужный вариант во всплывающем меню:
    ...
    ![Пример всплывающего меню с конфигурациями решения](multi-process-debugging-images/mpd03-xs.png)
...
3. **Целевые устройства.** Выбирает устройства, на которых будет выполняться решение. Для каждого проекта можно определить отдельное устройство или эмулятор:
    ...
    ![Всплывающее окно с отображением устройств для проекта](multi-process-debugging-images/mpd04-xs.png)
...
![Панель выходных данных для конфигурации решения](multi-process-debugging-images/mpd05-xs.png)
...
![Панель потоков для конфигурации решения](multi-process-debugging-images/mpd06-xs.png)
...
![Отладка двух проектов в Visual Studio для Mac](multi-process-debugging-images/mpd09-xs.png)
...
![Приостановка и возобновление на панели потоков](multi-process-debugging-images/mpd08-xs.png)
...
![Панель инструментов отладки](multi-process-debugging-images/mpd07-xs.png)
...
![Пункт "Начать отладку элемента"](multi-process-debugging-images/mpd13-xs.png)
...
1. В Visual Studio для Mac откройте диалоговое окно **Параметры решения**, а затем выберите **Запуск > Конфигурации**:
    ...
    ![Конфигурация решения в диалоговом окне "Параметры решения"](multi-process-debugging-images/mpd10-xs.png)
...
2. Нажмите кнопку **Создать**, введите имя новой конфигурации решения и нажмите кнопку **ОК**. Новая конфигурация решения появится в окне **Конфигурации**:
    ...
    ![Задание имени новой конфигурации решения](multi-process-debugging-images/mpd11-xs.png)
...
3. Выберите новую конфигурацию запуска в списке конфигураций. В диалоговом окне **Параметры решения** появится каждый проект в решении. Выберите каждый проект, который должен быть запущен при инициации сеанса отладки:
    ...
    ![Выбор проекта для запуска](multi-process-debugging-images/mpd12-xs.png)
