...
- [Общие сведения](#overview)  &  [Журнал](#history)
...
Цель Шарпие использует Clang для анализа файлов заголовков, поэтому привязка является как можно точной и максимально полной. Это может значительно сократить время и усилия, требуемые для создания привязки качества.
